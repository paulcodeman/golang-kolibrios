...
func (app *App) Init() {
	...
	app.send.Width = 152
	app.send.Height = 30
	app.send.Background = ui.Blue
	app.send.Foreground = ui.White
	app.send.TextPaddingX = 10
	app.send.TextPaddingY = 8
	...
	app.clear.Width = 96
	app.clear.Height = 30
	app.clear.Background = ui.Blue
	app.clear.Foreground = ui.White
	app.clear.TextPaddingX = 10
	app.clear.TextPaddingY = 8
