...
const (
	...
	messageWindowTitle = "KolibriOS Messages"
...
func NewApp() App {
	injectButton := ui.NewButton(messageButtonInjectButton, "Inject button", 28, 192)
	injectButton.Width = 150

	injectKey := ui.NewButton(messageButtonInjectKey, "Inject key", 198, 192)
	injectKey.Width = 132

	reset := ui.NewButton(messageButtonReset, "Reset", 350, 192)
	reset.Width = 100
